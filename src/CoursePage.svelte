<script>
    ...
    import { getDoc, doc, getFirestore, deleteDoc } from "firebase/firestore/lite";
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Deleting {course_name}</h5>
                <button
                    type="button"
                    class="btn-close"
            ...
            <div class="modal-body">
                <p>Are you sure you would like to delete {course_name}?</p>
            </div>
            <div class="modal-footer">
                ...
                >
                <button type="button" class="btn btn-danger" on:click={deleteCourse}>Delete</button>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    {#each historyNames as pastCourse}
                        <li>
                            <a href={pastCourse.link} class="dropdown-item"
                                >{pastCourse.name}</a
                            >
                        </li>
                    {/each}
